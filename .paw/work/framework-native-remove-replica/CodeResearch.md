...
- **Complexity Measurement**:
  `python3 scripts/measure-switchover-complexity.py` and
...
- `scripts/measure-switchover-complexity.py:15-90`,
  `scripts/measure-switchover-complexity.py:285-329` — remove pilot
  attribution and comparison-only amortization classifier.
- `scripts/tests/test_measure_switchover_complexity.py:19-140` — registry,
  baseline, ratio, and classifier tests.
...
- `docs/features/kuberic/durable-execution-roadmap.md:34-50`,
  ...
  explicit defaults, source comparison, and current byte measurements.
