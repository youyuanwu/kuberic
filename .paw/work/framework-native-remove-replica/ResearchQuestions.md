...
6. What do the authoritative checkpoint measurement fixture and scripts report for merged PR #59, including exact executable-line, decision-point, accepted-write, active-checkpoint, terminal-checkpoint, and terminal-payload measurements?
7. Which documentation and examples still frame remove-replica as a pilot or expose explicit/durable selection, and which complexity thresholds exist only for the now-closed amortization comparison?
